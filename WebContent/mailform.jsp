...
<body>
	...
	<div class="container">
		...
		<form action="selectMailsend.do" method="post">
			<fieldset>
				<legend>
					richiesta di contatto a: <span class="mailclass"><%=destinatario%></span>
				</legend>
				<div class="row">
				...
				<div class="row">
					<div class="col-xs-8 col-sm-5 col-md-4 col-lg-3">
						<div class="form-group">
							<label for="note">eventuali note:</label>
			...
			<input type="hidden" name="param_1" id="param_1" value="<%=destinatario%>"> <input type="hidden"
				name="param_2" id="param_2" value="<%=mittente%>"> <input type="hidden" name="param_3" id="param_3"
				value="<%=oggetto%>"> <input type="hidden" name="param_4" id="param_4" value="<%=contenuto%>"> <input
				type="submit" name="invia" id="invia" value="INVIA COMUNICAZIONE">
		</form>
	</div>
</body>
</html>